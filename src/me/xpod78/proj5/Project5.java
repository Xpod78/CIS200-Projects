	...
	public static void main(String[] args) {
		...
		do{
			...
			//Custom loan - enter custom values
				...
				writeToFile(filename, customerId, loanAmt, interest, term, monthlyPayment, totalPayment);
			}else if(count == 3) {
...
private static void writeToFile(String filename, String customerId, int loanAmt, double interest, int term,
